...
?>
<?php 
$allCheckQueue = getAllCheckQueue();
    ...
    <div class="hero-full-wrapper">
      <div class="grid">
        ...
        <table class="table">
          ...
          <tbody>
            <?php if(empty($allCheckQueue)){ ?>
            <?php }else{?>
              <?php $i=1;?>
              <?php foreach($allCheckQueue as $data){ ?>
                <tr>
                  ...
                  <td style="text-align: right;">
                    <a href="check_queue.php?id=<?php echo $data['id'];?>" class="btn btn-warning btn-lg">ตรวจสอบ</a>
                  </td>
                </tr>
              <?php } ?>
            <?php } ?>
