...
?>
<?php 
$allCheckPayment = getAllCheckPayment();
    ...
    <div class="hero-full-wrapper">
      <div class="grid">
        ...
        <table class="table">
          ...
          <tbody>
            <?php if(empty($allCheckPayment)){ ?>
            <?php }else{?>
              <?php $i=1;?>
              <?php foreach($allCheckPayment as $data){ ?>
                <tr>
                  ...
                  <td style="text-align: right;">
                    <a href="check_payment.php?id=<?php echo $data['id'];?>" class="btn btn-warning btn-lg">ตรวจสอบ</a>
                  </td>
                </tr>
              <?php } ?>
            <?php } ?>
